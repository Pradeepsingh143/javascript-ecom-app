        ...
        <div className="mt-6 space-y-6">
              ...
              <div className="flex items-center justify-end flex-1 gap-2">
                <form>
                  ...
                  <input
                    ...
                    defaultValue="1"
                    id="Line1Qty"
                    className="h-8 w-12 rounded border-2 border-black bg-yellow-100/50 p-0 text-center text-xs text-black [-moz-appearance:_textfield] focus:outline-none [&::-webkit-outer-spin-button]:m-0 [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:m-0 [&::-webkit-inner-spin-button]:appearance-none"
                  />
                </form>
          ...
          <div className="space-y-4 text-center">
            ...
            <Link
              to={'/checkout'}
              onClick={toggleCart}
              className="block px-5 py-3 text-sm text-white transition rounded-full bg-rose-900 hover:ring-1 hover:ring-rose-900"
            >
              Checkout
            </Link>
